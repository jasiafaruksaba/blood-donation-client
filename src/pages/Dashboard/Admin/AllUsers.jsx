            ...
            {users
              ...
              .map((user) => (
                <tr key={user._id || user.email}>
                    ...
                    <div className="avatar">
                      <div className="w-12 rounded-full">
                        <img
                          src={
                            user?.avatar ||
                            `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.name || "User")}&background=ef4444&color=fff`
                          }
                          alt={user?.name || "User"}
                        />
                      </div>
                  ...
                  <td className="font-bold">{user?.name || "Unknown"}</td>
                  <td className="font-mono text-sm">{user.email}</td>
                  <td>
                    <span className={`badge badge-lg gap-2 ${user.role === "admin" ? "badge-primary" :
                  ...
                  <td>
                    <span className={`badge badge-lg gap-2 ${user.status === "active" ? "badge-success" : "badge-error"
                      }`}>
                      {user.status}
                    </span>
                  </td>
                      ...
                      <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
                        <li>
                          <button
                            ...
                            className={`${user.status === "active" ? "btn-error" : "btn-success"
